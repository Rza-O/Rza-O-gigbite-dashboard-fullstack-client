   ...
   return (
      <div className='p-6'>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4 container mx-auto">
            <StatCard title="Total Submission" value="50" percentage="45.0" isIncrease />
            <StatCard title="Submission Pending" value="20" percentage="12.5" />
            <StatCard title="Total Earnings" value="€500" percentage="35.2" isIncrease />
         </div>
      </div>
   );
};
